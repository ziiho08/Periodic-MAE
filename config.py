...
_C.TRAIN.RESUME_PRETRAIN = False
...
_C.VALID.DATA.PREPROCESS.CROP_FACE.BACKEND = 'RF'
...
# -----------------------------------------------------------------------------\
_C.TEST = CN()
_C.TEST.OUTPUT_SAVE_DIR = './runs/exp/pickle/'
_C.TEST.METRICS = []
...
_C.TEST.DATA.PREPROCESS.CROP_FACE.BACKEND = 'RF'
...
# -----------------------------------------------------------------------------
# Model Settings for Periodic-MAE
# -----------------------------------------------------------------------------
_C.TRAIN.DATA.PURE = CN()
_C.TRAIN.DATA.MMPD = CN()
_C.TRAIN.DATA.UBFCrPPG = CN()

_C.TRAIN.DATA.PURE.DATA_PATH = ''
_C.TRAIN.DATA.MMPD.DATA_PATH = ''
_C.TRAIN.DATA.UBFCrPPG.DATA_PATH = ''

_C.TRAIN.DATA.PURE.CACHED_PATH = ''
_C.TRAIN.DATA.MMPD.CACHED_PATH = ''
_C.TRAIN.DATA.UBFCrPPG.CACHED_PATH = ''

_C.TRAIN.DATA.PURE.DATA_FORMAT = ''
_C.TRAIN.DATA.MMPD.DATA_FORMAT = ''
_C.TRAIN.DATA.UBFCrPPG.DATA_FORMAT = ''

_C.TRAIN.DATA.MMPD.INFO = CN()
_C.TRAIN.DATA.MMPD.INFO.LIGHT = ['']
_C.TRAIN.DATA.MMPD.INFO.MOTION = ['']
_C.TRAIN.DATA.MMPD.INFO.EXERCISE = [True]
_C.TRAIN.DATA.MMPD.INFO.SKIN_COLOR = [1]
_C.TRAIN.DATA.MMPD.INFO.GENDER = ['']
_C.TRAIN.DATA.MMPD.INFO.GLASSER = [True]
_C.TRAIN.DATA.MMPD.INFO.HAIR_COVER = [True]
_C.TRAIN.DATA.MMPD.INFO.MAKEUP = [True]



_C.TRAIN.DATA.PURE.BEGIN =  0.0
_C.TRAIN.DATA.MMPD.BEGIN =  0.0
_C.TRAIN.DATA.UBFCrPPG.BEGIN =  0.0

_C.TRAIN.DATA.PURE.END =  1.0
_C.TRAIN.DATA.MMPD.END = 1.0
_C.TRAIN.DATA.UBFCrPPG.END =  1.0

_C.TRAIN.DATA.PURE.FS =  30
_C.TRAIN.DATA.MMPD.FS = 30
_C.TRAIN.DATA.UBFCrPPG.FS = 30

_C.TRAIN.DATA.PURE.DATASET =  ''
_C.TRAIN.DATA.MMPD.DATASET = ''
_C.TRAIN.DATA.UBFCrPPG.DATASET = ''

_C.TRAIN.DATA.PURE.DO_PREPROCESS =  False
_C.TRAIN.DATA.MMPD.DO_PREPROCESS = False
_C.TRAIN.DATA.UBFCrPPG.DO_PREPROCESS = False

_C.TRAIN.DATA.PURE.MASK_RATIO = 0.7
_C.TRAIN.DATA.MMPD.MASK_RATIO = 0.7
_C.TRAIN.DATA.UBFCrPPG.MASK_RATIO = 0.7

_C.TRAIN.DATA.PURE.EXP_DATA_NAME =  ''
_C.TRAIN.DATA.MMPD.EXP_DATA_NAME = ''
_C.TRAIN.DATA.UBFCrPPG.EXP_DATA_NAME = ''

_C.TRAIN.DATA.PURE.PREPROCESS = CN()
_C.TRAIN.DATA.MMPD.PREPROCESS = CN()
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS = CN()

_C.TRAIN.DATA.PURE.PREPROCESS.DATA_TYPE = ['']
_C.TRAIN.DATA.MMPD.PREPROCESS.DATA_TYPE = ['']
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.DATA_TYPE = ['']


_C.TRAIN.DATA.PURE.PREPROCESS.DATA_AUG = ['']
_C.TRAIN.DATA.MMPD.PREPROCESS.DATA_AUG = ['']
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.DATA_AUG = ['']

_C.TRAIN.DATA.PURE.PREPROCESS.USE_PSUEDO_PPG_LABEL  = False
_C.TRAIN.DATA.MMPD.PREPROCESS.USE_PSUEDO_PPG_LABEL  = False
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.USE_PSUEDO_PPG_LABEL  = False



_C.TRAIN.DATA.PURE.PREPROCESS.LABEL_TYPE = ''
_C.TRAIN.DATA.MMPD.PREPROCESS.LABEL_TYPE = ''
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.LABEL_TYPE = ''

_C.TRAIN.DATA.PURE.PREPROCESS.DO_CHUNK = True
_C.TRAIN.DATA.MMPD.PREPROCESS.DO_CHUNK = True
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.DO_CHUNK = True

_C.TRAIN.DATA.PURE.PREPROCESS.CHUNK_LENGTH = 160
_C.TRAIN.DATA.MMPD.PREPROCESS.CHUNK_LENGTH = 160
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CHUNK_LENGTH = 160


_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE = CN()
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE = CN()
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE = CN()

_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE.BACKEND = 'HC'
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE.BACKEND = 'HC'
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE.BACKEND = 'HC'

_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE.DO_CROP_FACE = True
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE.DO_CROP_FACE = True
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE.DO_CROP_FACE = True


_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE.BACKEND = ''
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE.BACKEND = ''
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE.BACKEND = ''


_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE.USE_LARGE_FACE_BOX = True
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE.USE_LARGE_FACE_BOX = True
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE.USE_LARGE_FACE_BOX = True


_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE.LARGE_BOX_COEF = 1.5
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE.LARGE_BOX_COEF = 1.5
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE.LARGE_BOX_COEF = 1.5

_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE.DETECTION = CN()
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE.DETECTION = CN()
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE.DETECTION = CN()

_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE.DETECTION.DO_DYNAMIC_DETECTION = False
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE.DETECTION.DO_DYNAMIC_DETECTION = False
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE.DETECTION.DO_DYNAMIC_DETECTION = False

_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE.DETECTION.DYNAMIC_DETECTION_FREQUENCY =  30
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE.DETECTION.DYNAMIC_DETECTION_FREQUENCY =  30
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE.DETECTION.DYNAMIC_DETECTION_FREQUENCY =  30

_C.TRAIN.DATA.PURE.PREPROCESS.CROP_FACE.DETECTION.USE_MEDIAN_FACE_BOX = False
_C.TRAIN.DATA.MMPD.PREPROCESS.CROP_FACE.DETECTION.USE_MEDIAN_FACE_BOX = False
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.CROP_FACE.DETECTION.USE_MEDIAN_FACE_BOX = False

_C.TRAIN.DATA.PURE.PREPROCESS.RESIZE = CN()
_C.TRAIN.DATA.MMPD.PREPROCESS.RESIZE = CN()
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.RESIZE = CN()

_C.TRAIN.DATA.PURE.PREPROCESS.RESIZE.H = 128
_C.TRAIN.DATA.MMPD.PREPROCESS.RESIZE.H = 128
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.RESIZE.H = 128

_C.TRAIN.DATA.PURE.PREPROCESS.RESIZE.W = 128
_C.TRAIN.DATA.MMPD.PREPROCESS.RESIZE.W = 128
_C.TRAIN.DATA.UBFCrPPG.PREPROCESS.RESIZE.W = 128

_C.TRAIN.DATA.UBFCrPPG.FILTERING = CN()
_C.TRAIN.DATA.UBFCrPPG.FILTERING.USE_EXCLUSION_LIST = False
_C.TRAIN.DATA.UBFCrPPG.FILTERING.EXCLUSION_LIST = ['']
_C.TRAIN.DATA.UBFCrPPG.FILTERING.SELECT_TASKS = False
_C.TRAIN.DATA.UBFCrPPG.FILTERING.TASK_LIST = ['']
