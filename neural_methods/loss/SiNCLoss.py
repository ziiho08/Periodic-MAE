"""The loss for SiNC model.

Details for the loss function, see https://github.com/CVRL/SiNC-rPPG.
If you use this loss function, please cite this paper:
Speth, J., Vance, N., Flynn, P., & Czajka, A. (2023). Non-contrastive unsupervised learning of physiological signals from video. In Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (pp. 14464-14474).
"""
...
def torch_power_spectral_density(x, nfft=5400, fps=30, low_hz=2/3, high_hz=3.0, return_angle=False, radians=True, normalize=True, bandpass=True):
    fps = float(fps)
    low_hz = float(low_hz)
