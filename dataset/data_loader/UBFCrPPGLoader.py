"""The dataloader for UBFCrPPG dataset.

Details for the UBFCrPPG Dataset see https://sites.google.com/view/ybenezeth/ubfcrppg.
...
class UBFCrPPGLoader(BaseLoader):
    ...
    def get_raw_data(self, data_path):
        ...
        data_dirs = sorted(data_dirs, key=lambda x: int(x.split('subject')[-1]))
